...
Once you have created the component, add it to the Ad Studio menu using the *Resources* menu in the Flite Console. Then open an ad in Ad Studio v3. Your new component will appear in the component list on the right. Add the component to the stage and you will see the "Rectangle Color" and "Rectangle Transparency" settings you created in the *Settings* section of the component *Inspector*. Adjust these as you wish.
