This code example creates an ad that tracks hovers and clicks on two custom navigation buttons, and displays the tracked events in a text area. To see it in action, do the following:
