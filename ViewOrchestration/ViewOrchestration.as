...
function apiInit (inAPI:Object):Void		
{
	...
	var v2_config:Object			= 	_api.config.getContentConfig (3)
		v2_config.width				= 	300
		v2_config.height			= 	250
	_api.ui.factory.getView (vid2, "LowerLeft", v2_config, Delegate.create (this, vidLoaded), null )

	// Now configure the Facebook, Twitter and Blog feeds.
	// Let's give each one a different color scheme using Flite's theme colors.
	var facebook_config:Object		=	_api.config.getContentConfig (0)
		facebook_config.width		=	280
		facebook_config.height		=	508
		facebook_config.backgroundColor = _api.util.string.hexStringToInt("#0096c4")
		facebook_config.textColor = _api.util.string.hexStringToInt("#ffffff")
		facebook_config.linkColor = _api.util.string.hexStringToInt("#f26136")
		facebook_config.feedMax = 10
	var twitter_config:Object		=	_api.config.getContentConfig (1)
	...
	var blog_config:Object			=	_api.config.getContentConfig (4)
	...
	FacebookButton.onPress = Delegate.create(this, function () {
		cleanHolder()
		_api.ui.factory.getView (feeds, "Right1", facebook_config, Delegate.create (this, feedLoaded), null )
	});
