This code example creates an ad that repositions and reformats content within the ad, and creates a custom navigation system. To see it in action, do the following:
